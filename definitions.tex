...
specifying the same \grammarterm{module-name}. See \Cpp~Standard [module.unit]
paragraph 1.

\indexdefn{module!unit}
\definition{module unit}{definitions.module-unit}
A translation unit that contains a \grammarterm{module-declaration}. See \Cpp
...
\grammarterm{export-keyword}. See \Cpp~Standard [module.unit] paragraph 2.
...
\grammarterm{module-partition}. A module partition can only consist of a single
...
\tcode{import} directive. See \Cpp~Standard [cpp.include] paragraph 7.
